...
namespace Pos.Orders
{
    public partial class UCSaleOrderAdd : UserControl
    {
        ...
        private void UCSaleOrderAdd_Load(object sender, EventArgs e)
        {
            ...
            if (listView2.Items.Count > 0)
            {
                ...
                using (OleDbTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        sqlstring = "INSERT INTO " + BaseConfigs.GetTablePrefix + "SaleOrders(OrderID,OrderDate,CustomerName,SaleName,TotalPrice,Freight,Descn) VALUES(@OrderID,@OrderDate,@CustomerName,@SaleName,@TotalPrice,@Freight,@Descn)";
                        ...
                        {
                            sqlstring = "INSERT INTO " + BaseConfigs.GetTablePrefix + "SaleProducts(OrderID,ProductNo,Name,Num,SellPrice,ColorName,UnitName) VALUES(@OrderID,@ProductNo,@Name,@Num,@SellPrice,@ColorName,@UnitName)";
